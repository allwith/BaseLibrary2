...
public class SPManager {
    ...
    private static String getStringValue(String key, String default_value) {
    ...
    private static long getLongValue(String key, long default_value) {
    ...
    private static boolean getBooleanValue(String key, boolean default_value) {
