...
public class RLog {
    ...
    private static String mGlobalTag = "";  //默认的全局Tag
    private static boolean mSwitchLog = true; // log是否启用的开关
    private static boolean mLogFile = false; //是否写入文件log
...
//         * @return
//         */
//        public Builder isLogFile(boolean isLogFile) {
//            mLogFile = isLogFile;
//            return this;
//        }
